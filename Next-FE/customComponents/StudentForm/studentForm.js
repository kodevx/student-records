...
import useStudentForm from '@/customHooks/StudentForm/useStudentForm';
                ...
                {({ values, touched, errors, handleSubmit, handleChange, handleBlur, isSubmitting, resetForm }) => (
                    ...
                    >
                        ...
                        <TextInput 
                            ...
                            classes={{
                                root: 'flex flex-col',
                                input: 'p-3 bg-white border-2 border-yellow-400 border-solid outline-none text-grey-400',
                                error: 'pt-3 text-red-500'
                            }}
                        />
                        {/* <TextInput                      // TODO: Refactor it to Select Component
                            name={'gender'}
                            type={'gender'}
                            value={values.gender}
                        ...
                        <Select
                            ...
                            classes={{
                                // root: 'flex flex-col',
                                root: 'p-3 bg-white border-2 border-yellow-400 border-solid outline-none text-grey-300',
                                error: 'pt-3 text-red-500'
                            }}
                        />
                        <TextInput
